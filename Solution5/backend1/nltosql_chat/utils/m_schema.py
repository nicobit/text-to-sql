from nltosql_chat.utils.utils import examples_to_str, read_json, write_json
...
class MSchema:
    ...
    def to_mschema(self, selected_tables: List = None, selected_columns: List = None,
        ...
        selected_tables: Defaults to None, meaning all tables are selected.
        selected_columns: Defaults to None, meaning all columns are selected, format ['table_name.column_name'].
        """
        output = []
        ...
        # Add foreign key information, do not display foreign keys when the table_type is 'view'
