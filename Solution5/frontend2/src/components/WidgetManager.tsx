...
export default function WidgetManager() {
  ...
  return (
    <div className="flex flex-col w-full h-full" >
      ...
      <div className="flex  bg-gray-100 dark:bg-gray-900 border-b border-gray-300 dark:border-gray-700 p-2" style={{ height: 'auto' }}>
        ...
        {state.tabs.map((tab, i) => {
          ...
          return (
            <Tab
              ...
              style={{ cursor: 'pointer', minWidth: 'auto', padding: '0 1rem', whiteSpace: 'nowrap', fontWeight: 'normal' }}
              placeholder=""
            >
          ...
          {editMode && (  
            <button
              ...
              className="ml-2 p-1 hover:bg-gray-200 dark:hover:bg-blue-100 focus:outline-none no-drag"
