        ...
        <div style={{ height: '100%' }}>
            <h2>Chat</h2>
             <Box sx={{ display: 'flex', height: '80%' }}>
                        <ChatSideBar/>
                        <Box  sx={{ flexGrow: 1, p: 2, display: 'flex', flexDirection: 'column', height: isCollapsed ? '100%' : '0%', boxSizing: 'border-box' }}>
                            <Box sx={{ flexGrow: 1, overflowY: 'auto', height: '100%' }}>
                                <Chat />
                            </Box>
                            <Box sx={{ height: isCollapsed ? 'auto' : '100%', transition: 'height 0.3s ease' }}>
